...
/**
 * This class creates a WaterVapor particle, which implements the Particle interface. This class
 * contains logic to make the vapor float up, disperse, and contains methods to get the
...
public class WaterVapor implements Particle {
    ...
    /**
     * This method is the constructor of the WaterVapor class, and takes in x/y, radius, and color
    ...
    /**
     * This method makes the WaterVapor gas float up using a method called leapfrog integration.
    ...
    @Override
    public void gravity() {
        Constants.GRAVITY = Constants.VAPOR_GRAVITY;
