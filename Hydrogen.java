...
/**
 * This class creates a Hydrogen particle, which implements the Particle interface. This class
 * contains logic to make the hydrogen float up, disperse, and contains methods to get the
 * particle and its state.
 */
public class Hydrogen implements Particle {
    ...
    /**
     * This method is the constructor of the Hydrogen class, and takes in x/y, radius, and color
     ...
     */
    public Hydrogen(double x, double y, int radius, Color color) {
        this.particle = new Circle(x, y, radius, color);
    }

    /**
     * This method makes the Hydrogen gas float up using a method called leapfrog integration.
