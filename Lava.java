...
/**
 * This class creates a Lava particle, which implements the Particle interface. This class
 * contains logic to make gravity affect the Particle and to get the particle as well as
 * it's state.
 */
public class Lava implements Particle {
    ...
    /**
     * This method is the constructor of the Lava class, and takes in x/y, radius, and color
     ...
     */
    public Lava(double x, double y, int radius, Color color) {
        this.particle = new Circle(x, y, radius, color);
        this.isSettled = false;
    }

    /**
     * This method makes the Lava fall using a method called leapfrog integration.
    ...
    @Override
    public void gravity() {
        Constants.GRAVITY = Constants.LAVA_GRAVITY;
    ...
    /**
     * This method is included since Lava implements Particle, so it must have the method. It is
     * empty since Lava shouldn't disperse by design.
     */
    @Override
